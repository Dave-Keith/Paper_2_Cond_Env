...
aug.sst.sum2 <- lm(data=aug.dat.comp, Condition ~ SST.sum + SST.cur)
summary(aug.sst.last)
summary(aug.sst.cur)
summary(aug.sst.sum)
summary(aug.sst.sum2)
AIC(aug.sst.last, aug.sst.cur, aug.sst.sum, aug.sst.sum2)
AICctab(aug.sst.last, aug.sst.cur, aug.sst.sum, aug.sst.sum2)

aug.bt.last <- lm(data=aug.dat.comp, Condition ~ BT.last)
summary(aug.bt.last)
AIC(aug.sst.last, aug.sst.cur, aug.sst.sum, aug.sst.sum2, aug.bt.last)
AICctab(aug.sst.last, aug.sst.cur, aug.sst.sum, aug.sst.sum2, aug.bt.last)

aug.bt.sum3 <- lm(data=aug.dat.comp, Condition ~ SST.last + SST.cur + BT.last)
summary(aug.bt.sum3)
AIC(aug.sst.last, aug.sst.cur, aug.sst.sum, aug.sst.sum2, aug.bt.last, aug.bt.sum3)
AICctab(aug.sst.last, aug.sst.cur, aug.sst.sum, aug.sst.sum2, aug.bt.last, aug.bt.sum3)

# SST sum wins for August.
...
may.sst.sum2 <- lm(data=may.dat.comp, Condition ~ SST.sum + SST.cur)
summary(may.sst.last)
summary(may.sst.cur)
summary(may.sst.sum)
summary(may.sst.sum2)
AIC(may.sst.last, may.sst.cur, may.sst.sum, may.sst.sum2)
AICctab(may.sst.last, may.sst.cur, may.sst.sum, may.sst.sum2)

may.bt.cur <- lm(data=may.dat.comp, Condition ~ BT.cur)
summary(may.bt.cur)
AIC(may.sst.last, may.sst.cur, may.sst.sum, may.sst.sum2, may.bt.cur)
AICctab(may.sst.last, may.sst.cur, may.sst.sum, may.sst.sum2, may.bt.cur)

may.bt.sum3 <- lm(data=may.dat.comp, Condition ~ SST.last + SST.cur + BT.cur)
summary(may.bt.sum3)
AIC(may.sst.last, may.sst.cur, may.sst.sum, may.sst.sum2, may.bt.cur, may.bt.sum3)
AICctab(may.sst.last, may.sst.cur, may.sst.sum, may.sst.sum2, may.bt.cur, may.bt.sum3)
