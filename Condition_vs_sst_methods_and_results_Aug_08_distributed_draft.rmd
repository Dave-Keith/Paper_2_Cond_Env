...
month.dat <- rbind(chl.mon,sst.mon,mld.mon)
...
dat.list <- list(chl = chl.raw.dat,mic = mic.raw.dat,mld = mld.raw.dat,sst = sst.raw.dat)
...
plot_grid(p1[[1]],p1[[2]],p1[[3]], align = "v", nrow = 3, rel_widths = 1.5)
